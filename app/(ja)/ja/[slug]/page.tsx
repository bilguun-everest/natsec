...
/**
 * Every Japanese page that is not the homepage.
 *
...
export async function generateMetadata({
  ...
  if (route === "not-found") {
    return { title: TITLES[route].ja, robots: { index: false, follow: false } };
  }

  return {
    title: TITLES[route].ja,
    alternates: {
      canonical: pathOf(route, "ja"),
